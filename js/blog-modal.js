document.addEventListener("DOMContentLoaded", async () => {
  ...
  // 3) auto open theo URL (?post=... hoặc #post-...)
  autoOpenFromUrl();

  // 4) observe changes (nếu include templates sau)
  ...
  async function waitForTemplates(timeoutMs = 6000) {
    ...
    console.warn("[BLOG] templates NOT found.");
    return [];
  }
  ...
  // ======================
  // ✅ SHARE FACEBOOK (PREVIEW ĐẸP)
  // ======================
  function buildShareUrl(postId) {
    // Dùng share page tĩnh để Facebook bot đọc OG meta
    return window.location.origin + "/share/" + encodeURIComponent(postId) + ".html";
  }
