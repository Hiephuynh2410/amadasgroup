(function () {
  ...
  window.amadasBlogModalInit = async function amadasBlogModalInit(options = {}) {
    ...
    state.cfg = {
      ...
      heroNewsIds: Array.isArray(options.heroNewsIds) ? options.heroNewsIds : ["post-01", "post-02", "post-03", "post-04", "post-05", "post-06", "post-07", "post-08"],
  ...
  function metaDateToMonth(meta = "") {
    ...
    parts[0] = d.toLocaleString("en-US", { month: "short", year: "numeric" });
    return parts.join(" • ");
  }
